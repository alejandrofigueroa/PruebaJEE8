...
public class SesionFiltro implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        //Se verifica la existencia de la variable de sesion
        if(wrappedRequest.getSession().getAttribute("user")==null){ 
            if(url.contains("index.xhtml") || url.contains("registro.xhtml")){
                chain.doFilter(request, response);
            }else{
                wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + "/faces/bienvenido.xhtml");
            }
